...
class BCQLTrainer:
    ...
    def rollout(self, render=False, plot=False,cbf=True):
        """
        Evaluates the performance of the model on a single episode.
        """
...
#python "/Users/i.k.tabbara/Documents/python directory/OSRL/examples/research/check/eval_bcql_modif.py" --path "/Users/i.k.tabbara/Documents/python directory/OSRL/logs/OfflineSwimmerVelocityGymnasium-v1-cost-20/BCQL_cost20_seed20-b8c5/BCQL_cost20_seed20-b8c5" --eval_episodes 20